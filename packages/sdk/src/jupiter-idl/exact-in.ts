// Pinned from Jupiter program-owned mainnet IDL; see README.md. Do not reorder enum variants.
export const JUPITER_EXACT_IN_IDL = {
  instructions: [
    {
      name: "route",
  ...
  types: {
    ...
    CandidateSwapWithBps: {
      ...
      fields: [
        {
          name: "candidate_swap",
          type: { defined: { name: "CandidateSwap" } },
        },
        { name: "bps", type: "u32" },
      ],
    },
    ...
    Swap: {
      ...
      variants: [
        ...
        {
          name: "Gatorswap",
          fields: [{ name: "base_to_quote", type: "bool" }],
        },
        {
          name: "Flint",
          fields: [
