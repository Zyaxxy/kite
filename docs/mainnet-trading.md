...
- `SOLANA_RPC_URL`: server-only mainnet RPC used to read actual balances; falls back to the public RPC configuration. The portfolio API checks the full mainnet genesis hash before reading balances.
